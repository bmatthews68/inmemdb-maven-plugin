...
/**
 * The interface that must be implemented by the object that logs messages to the Maven log file.
 * 
...
public interface Logger {
    ...
    /**
     * Write an error message to the Maven log and raise a {@link MojoFailureException}.
     * 
     * @param messageKey
     ...
     */
    void logErrorAndThrow(String messageKey, Object... arguments)
            throws MojoFailureException;
     ...
     */
    void logErrorAndThrow(String messageKey, Throwable exception, Object... arguments)
            throws MojoFailureException;
}
