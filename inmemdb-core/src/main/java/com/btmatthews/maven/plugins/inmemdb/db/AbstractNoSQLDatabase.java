...
/**
 * Abstract base classes for embedded NoSQL databases.
 *
 * @author <a href="mailto:brian@btmatthews.com">Brian Matthews</a>
 * @version 1.0.0
 */
public abstract class AbstractNoSQLDatabase extends AbstractDatabase implements NoSQLDatabase {
     ...
     */
    public AbstractNoSQLDatabase(final int port) {
        super(port);
    }
